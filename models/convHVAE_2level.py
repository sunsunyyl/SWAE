...
class VAE(Model):
    ...
    def generate_x_batch(self, N=25):
        ...
        if self.args.prior == 'standard':
            ...
            means = self.means(self.idle_input)[random_idx].view(-1, self.args.input_size[0], self.args.input_size[1],self.args.input_size[2])
    ...
    def decoder(self, z):  
        ...
        z = z.view(-1, self.args.z1_size + self.args.z2_size)      
        samples_gen, _ = self.p_x(z[:, 0:self.args.z1_size], z[:, self.args.z1_size:])
        return samples_gen
    ...
    def generate_x(self, N=25, return_z=False, z1=None, z2=None):
        if z2 is None:
            ...
            if self.args.prior == 'standard':
                ...
                means = self.means(self.idle_input)[random_idx].view(-1, self.args.input_size[0],
